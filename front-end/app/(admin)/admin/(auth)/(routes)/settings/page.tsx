  ...
  const handleUpdatePassword = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3002/api/registers/updatePassword",
        {
          method: "POST",
          headers: {
                  ...
                  <div className="flex items-center justify-between py-4 px-6 bg-gray-100 rounded-lg shadow-md">
                    ...
                    <div className="flex items-center">
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        ></div>
                        <div
                          className={`absolute w-6 h-6 bg-white border border-gray-300 rounded-full transform transition-transform ${
